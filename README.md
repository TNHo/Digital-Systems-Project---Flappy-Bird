...
What is VHDL? VHDL is a hardware description language. It is not exactly a "programming" language although it looks similar to one. It is used to describe the structure and behavhior of an electronic circuit.
